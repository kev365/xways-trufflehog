...
//  manager-plugin.h
//
//  Plugin contract for xways-xt-manager.
//
...
typedef struct {
    ...
    const wchar_t*  id;             // unique slug, e.g. L"xways-hindsight"
    const wchar_t*  display_name;   // tab caption + tools list, e.g. L"Hindsight"
